...
public class LeachController implements Initializable {
    ...
    LeachParameters parameters;
    double kx;
    double ky;
    private Boolean pause = false;
    private SimpleIntegerProperty count = new SimpleIntegerProperty(-1);

    public LeachController(Simulation simulation, LeachParameters parameters) {
            ...
            public void run() {
                Runnable updater = new Runnable() {
                    ...
                    public void run() {
                        ...
                        ArrayList<INode> nodes = simulation.getiRounds().get(count.get()).getNodes();
