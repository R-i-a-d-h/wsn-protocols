...
public class LeachRLParametersController implements Initializable {
    ...
    public void onRun(ActionEvent actionEvent) {
        ...
        if (!sinkxText.isEmpty()
            ...
            LeachRLParameters parameters = new LeachRLParameters(
            ...
            Task<RSimulation> task = new Task<RSimulation>() {
                ...
                protected RSimulation call() throws Exception {
                    /* send a http request */
                    LeachRL leachRL = new LeachRL(parameters);
                    return leachRL.run();
                }
            };
            ...
            task.setOnSucceeded(event -> {
                ...
                loader.setControllerFactory(e -> {
                    ...
                    return new LeachRLController(task.getValue(), parameters);
